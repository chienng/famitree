...
export const translations: Record<Locale, Record<string, string>> = {
  ...
  vi: {
    'app.tagline': 'Gia Phả dòng họ Nguyễn - Đức Thượng',
    ...
    'tree.print': 'In ấn',
    'tree.printTitle': 'Cây gia phả dòng họ Nguyễn - Đức Thượng',
    ...
    'auth.loginTitle': 'Đăng nhập Gia Phả Họ Nguyễn',
